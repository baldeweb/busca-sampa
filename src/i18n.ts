  ...
  fr: {
    translation: {
      ...
      placeDetail: {
        ...
        googleMapsButton: 'Ouvrir dans Google Maps',
  ...
  ru: {
    translation: {
      ...
      placeDetail: { loading: 'Загрузка деталей...', notFound: 'Место не найдено.', opensMonday: 'открыто по понедельникам', opensSunday: 'открыто по воскресеньям', opensHoliday: 'открыто в праздники', alreadyVisited: '✓ Уже был', notVisited: '⚠️ Еще не был', hoursTitle: 'Часы работы', viewHours: 'смотреть часы',
        ...
        googleMapsButton: 'Открыть в Google Maps',
  ...
  zh: {
    translation: {
      ...
      placeDetail: { loading: '正在加载详情...', notFound: '未找到地点。', opensMonday: '周一营业', opensSunday: '周日营业', opensHoliday: '节假日营业', alreadyVisited: '✓ 我去过', notVisited: '⚠️ 还没去过', viewHours: '查看营业时间',
        ...
        locationTitle: '地点',
        streetPrefix: '地址:',
        googleMapsButton: '在 Google 地图中打开',
        instagramTitle: 'Instagram',
  ...
  de: {
    translation: {
      ...
      placeDetail: {
        ...
        googleMapsButton: 'In Google Maps öffnen',
        instagramTitle: 'Instagram',
  ...
  ar: {
    translation: {
      ...
      placeDetail: {
        ...
        googleMapsButton: 'فتح في خرائط Google',
  ...
  it: {
    translation: {
      ...
      placeDetail: {
        ...
        googleMapsButton: 'Apri in Google Maps',
        instagramTitle: 'Instagram',
  ...
  nl: {
    translation: {
      ...
      placeDetail: {
        ...
        googleMapsButton: 'Openen in Google Maps',
        instagramTitle: 'Instagram',
  ...
  tr: {
    translation: {
      ...
      placeDetail: {
        ...
        googleMapsButton: 'Google Haritalar\'da aç',
        instagramTitle: 'Instagram',
  ...
  pl: {
    translation: {
      ...
      placeDetail: {
        ...
        googleMapsButton: 'Otwórz w Google Maps',
        instagramTitle: 'Instagram',
